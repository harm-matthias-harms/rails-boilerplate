...
gem 'tzinfo-data', '1.2024.1', platforms: %i[mingw mswin x64_mingw jruby]
...
group :development do
  ...
  gem 'database_consistency', '1.7.23', require: false
...
gem 'redcarpet', '3.6.0'
gem 'service_actor', '3.9.3'
gem 'service_actor-rails', '1.0.0'
gem 'stripe', '12.4.0'
gem 'valid_email2', '5.2.5'
