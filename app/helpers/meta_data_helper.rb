...
module MetaDataHelper
  def page_title(**kwargs)
    I18n.t("helpers.meta.title.#{controller_name}.#{action_name}", default: 'helpers.meta.title.default', **kwargs)
  end
  ...
  def page_robots(**kwargs)
    I18n.t("helpers.meta.robots.#{controller_name}.#{action_name}", default: 'helpers.meta.robots.default', **kwargs)
  end
end
